    ...
    <div className="min-h-screen bg-bg">
      ...
      <div className="px-8 py-8">
        <div className="flex items-center justify-between mb-8">
          <div className="w-32 h-8 bg-surface rounded-lg animate-pulse" />
          <div className="w-28 h-8 bg-accent/20 rounded-md animate-pulse" />
        </div>
          ...
          {[0,1,2,3].map(i => (
            <div key={i} className="flex items-center gap-4 px-4 py-4 bg-surface border border-border rounded-lg animate-pulse">
              ...
              <div className="flex gap-2">
                <div className="w-10 h-6 bg-bg rounded" />
                <div className="w-14 h-6 bg-bg rounded" />
              </div>
            </div>
          ))}
        </div>
